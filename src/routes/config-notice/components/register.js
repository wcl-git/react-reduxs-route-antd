...
class RegisterForm extends Component {
  ...
  render() {
    ...
    return (
      <ZCYForm editEnable={true} auditEnable={false}>
        <div className="register-config">
          <ZCYPanel.SubHeader title="注册公示与入库配置" />
...
export default Form.create({
  mapPropsToFields(props) {
    return props.registerConf
  },
  onFieldsChange(props, fields) {
    props.duplexFormData(fields, 'registerConf')
  }
})(RegisterForm)
